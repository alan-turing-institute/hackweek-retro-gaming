...
class BitmapFont:
    ...
    def draw(self, surface: Surface, message: str, x: int, y: int):
        for character in message:
            ...
            offset_y = (index / self.rows) * self.cell_height

            source_rectangle: tuple =  (offset_x, offset_y, self.cell_width, self.cell_height)
            surface.blit(self.image, (x, y, self.cell_width, self.cell_height), source_rectangle)
